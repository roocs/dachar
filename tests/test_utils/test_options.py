...
def test_project_dirs_no_env_var():
    ...
    assert options.get_project_base_dir("c3s-cmip5") == "/group_workspaces/jasmin2/cp4cds1/vol1/data/"
    assert options.get_project_base_dir("c3s-cmip6") == "NOT DEFINED YET"
    assert options.get_project_base_dir("c3s-cordex") == "/group_workspaces/jasmin2/cp4cds1/vol1/data/"
...
def test_project_dirs_paths_env_var():
    ...
    assert options.get_project_base_dir("c3s-cordex") == "c3s-cordex/file/path/for/tests"
