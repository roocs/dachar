...
test_path2 = 'tests/mini-esgf-data/test_data/group_workspaces/jasmin2/cp4cds1/data/c3s-cordex/output/EUR-11/IPSL/MOHC-HadGEM2-ES/' \
...
def test_coord_keys_and_dims_1():
    ...
    with pytest.raises(AssertionError):
        assert sorted(da.shape) == sorted([da[f'{coord}'].size for coord in da.coords.keys()])
