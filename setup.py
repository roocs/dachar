...
setup(
    ...
    dependency_links=['http://github.com/cedadev/time-checks/master#egg=time-checks',
                      'https://github.com/cedadev/ceda-elasticsearch-tools#egg=ceda-elasticsearch-tools'],
